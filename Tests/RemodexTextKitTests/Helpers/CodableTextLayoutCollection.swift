  ...
  struct CodableTextLayoutCollection: Equatable, TextLayoutCollection {
    var layouts: [any RemodexTextKit.TextLayout] {
      _layouts
    }

    let _layouts: [CodableTextLayout]

    func isEqual(to other: any RemodexTextKit.TextLayoutCollection) -> Bool {
      _layouts == (other as? CodableTextLayoutCollection)?._layouts
    }

    func needsPositionReconciliation(with other: any RemodexTextKit.TextLayoutCollection) -> Bool {
      false
    }
  ...
  struct CodableTextLayout: Equatable, TextLayout {
    var lines: [any RemodexTextKit.TextLine] {
      _lines
    }
  ...
  struct CodableTextLine: Equatable, Codable, TextLine {
    ...
    var runs: [any RemodexTextKit.TextRun] {
      _runs
    }
  ...
  struct CodableTextRun: Equatable, Codable, TextRun {
    ...
    var slices: [any RemodexTextKit.TextRunSlice] {
      _slices
    }
