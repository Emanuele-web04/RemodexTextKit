...
/// Converts markup into attributed content that RemodexTextKit can render.
///
...
/// RemodexTextKit-specific attributes used for attachments and custom emoji.
///
/// RemodexTextKit looks for a small set of well-known attributes when rendering:
///
...
/// ```
///
/// If you implement your own parser, keep the output stable and deterministic. RemodexTextKit may call
...
/// RemodexTextKit groups content into blocks by walking `PresentationIntent` changes across runs, so
