...
extension StructuredText {
  ...
  public struct CodeBlockProxy {
    ...
    ///
    /// RemodexTextKit writes both a plain-text and an HTML representation when possible.
    @available(tvOS, unavailable)
    @available(watchOS, unavailable)
    public func copyToPasteboard() {
      #if REMODEX_TEXT_KIT_ENABLE_TEXT_SELECTION && canImport(AppKit)
      ...
      #elseif REMODEX_TEXT_KIT_ENABLE_TEXT_SELECTION && canImport(UIKit)
        let formatter = Formatter(AttributedString(content))
