...
/// `AttributedString` that RemodexTextKit can lay out and display.
///
...
extension StructuredText {
  ...
  ///
  /// This is a convenience initializer that uses RemodexTextKit’s Markdown parser. To render other
