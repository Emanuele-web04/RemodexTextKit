...
///
/// RemodexTextKit passes `TextEnvironmentValues` to APIs that need to resolve styling or sizing based on
...
public struct TextEnvironmentValues: Hashable, Sendable {
  ...
  /// Properties that control how RemodexTextKit renders emoji.
  public var emojiProperties: EmojiProperties

  /// Properties that control how RemodexTextKit renders math expressions.
